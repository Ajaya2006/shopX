            ...
            <form className="space-y-6">
              ...
              >
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 pr-12 ${gradients.glassLight[theme]} rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition-all text-gray-900 dark:text-white placeholder-gray-500`}
                />
                <button
                  type="button"
              ...
              <SectionButton variant="checkout" type="submit" className="w-full">
                Create Account
              </SectionButton>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="button"
                className={`w-full ${gradients.glassLight[theme]} py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-semibold flex items-center justify-center gap-3 text-gray-900 dark:text-white`}
              >
